...
- **IMMC2024 USA Regional – Pets Paper**  
  ...
  **Summary**: Designed the Household Readiness Model for Pets, a framework assessing household suitability for cat ownership by balancing human and pet welfare. It applies modified cosine similarity and vector projection methods to compare household factors like finances, environment, and commitment.  
...
- **MTFC2023 – Lake Mead Paper (3rd Place Win)**  
  ...
  **Summary**: Created a forecasting model using symbolic regression and Facebook Prophet to project Lake Mead’s water decline and its hydroelectric impact through 2030. The analysis estimated a 29.2% volume drop, $440M in replacement energy costs, and proposed mitigation strategies based on environmental and consumption factors.  
...
- **HiMCM2023 – E-Bus Paper**  
  ...
  **Summary**: Built a constrained optimization model using Lagrange Multipliers to plan cost-effective electric bus adoption across major cities. The model optimized bus and charger counts while factoring in energy pricing, route data, and ecological benefits.  
...
- **MTFC2022 – Melanoma Paper**  
  ...
  **Summary**: Developed a geospatial model correlating melanoma incidence with UV exposure, elevation, and demographics using ArcGIS and regression analysis. The results highlighted high-risk U.S. regions and informed targeted public health strategies.  
...
- **IMMC2022 USA Regional – Plane Boarding Paper**  
  ...
  **Summary**: Designed a simulation-based model to test and optimize airline boarding methods using Python and R. The model incorporated passenger variability and demonstrated superior performance over standard boarding strategies.  
...
- **HiMCM2022 – Honey Bees Paper**  
  ...
  **Summary**: Simulated honey bee population dynamics under environmental and biological pressures using R-based modeling. The study identified optimal hive counts for orchard pollination and key factors affecting colony survival.  
...
- **HiMCM2021 – Electric Batteries Paper**  
  ...
  **Summary**: Evaluated residential battery technologies by modeling power demand and energy efficiency across household appliances. The simulation identified Tesla Powerwall 2 as the optimal system and assessed the feasibility of next-gen batteries.  
